...
This guide covers the database migration system used in Field Notes. Migrations are managed using [pymongo-migrate](https://github.com/pymongo-migrate/pymongo-migrate), a lightweight migration framework for MongoDB.
